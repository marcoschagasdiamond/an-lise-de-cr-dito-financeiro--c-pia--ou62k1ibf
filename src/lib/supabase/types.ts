...
//   $function$
//
// FUNCTION validate_login(character varying, character varying)
//   CREATE OR REPLACE FUNCTION public.validate_login(p_email character varying, p_senha character varying)
